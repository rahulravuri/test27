document.addEventListener("DOMContentLoaded",(function () { // Same as document.addEventListener("DOMContentLoaded"...
...
$ajaxUtils.sendGetRequest(
  allCategoriesUrl,
  function (ct) {
  buildAndShowHomeHTML(ct);}, // ***** <---- TODO: STEP 1: Substitute [...] ******
  true); 
...
function buildAndShowHomeHTML (categories) {
  ...
  // Load home snippet page
    var randomCategoryShortName = chooseRandomCategory (categories);
	          console.log(randomCategoryShortName.short_name);
		    html =  insertProperty(homeHtmlUrl,
                     "x",
                     randomCategoryShortName.short_name);

    $ajaxUtils.sendGetRequest(
    homeHtmlUrl,
    function (homeHtml) {
		homeHtml=insertProperty(homeHtml,
                     "x",
                     randomCategoryShortName.short_name);
